...
class APITest(APITestCase):
    ...
    def test_create(self):
        ...
        self.assertEqual(VPost.objects.count(), 1)
        self.assertEqual(VPost.objects.get().title, data["title"])
    ...
    def test_update(self):
        ...
        self.assertEqual(VPost.objects.count(), test_post.id)
        self.assertEqual(VPost.objects.get().title, data["title"])
